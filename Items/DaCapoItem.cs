	...
	public class DaCapoItem : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault(
				...
				"Left click to launch melee attacks that weaken enemies' immunity frames\n" +
				"Hold the right click on the ground to play, but user cannot move at this time.\n" +
				"During the performance, you will alternately be immune to melee and projectile damage, and will have a much high resistance to the other damage\n" +
				...
				"Your health will return to the peak after finishing playing\n" +
				"Each performance has a 5 second cooldown.");
			Tooltip.AddTranslation(GameCulture.Chinese, 
				"持有者挥舞这把镰刀时宛如一名沉默而温和的指挥家，\n" +
				"而它的总谱就是对世界末日的警告。\n" +
				...
				"左键可以发动近战攻击并削弱敌人无敌帧\n" +
				"在地面上按住右键可以进行演奏，此时无法移动\n" +
				"演奏中你会轮流免疫近战和弹幕伤害，不免疫的效果会获得较高的减伤\n" +
